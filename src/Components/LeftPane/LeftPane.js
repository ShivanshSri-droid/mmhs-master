      ...
      <ul>
        <Link to="/">
          <li
            ...
            className={
              filter === 0
                ? "left_pane__selected_style"
                : "left_pane__normal_style"
            }
            // style={{selectedStyle}}
        ...
        <Link to="fee_report">
          <li
            ...
            className={
              submenu
                ? filter == 12
                  ? "left_pane__selected_style submenu_visible"
                  : "left_pane__normal_style submenu_visible"
                : "submenu_invisible"
            }
          >
            Fee Report
