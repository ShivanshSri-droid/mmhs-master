...
const Circular = () => {
  ...
  return(
      <div className="circular">
          <div className={value===0?"circular__form_div_not_open":"circular__form_div_open"}>
            <div className="circular__form">
              ...
              <div className="circular__form_input ">
                ...
                <input type="text" className=" circular__form_input_small input_date"/>
          ...
          <div className="circular__top">
                ...
                <div className="circular__top_button_left_most">
                    <button type="button" className="circular__top_button_circular circular__top_button_go" onClick={handleClick1} >Add Circular</button>
                </div>
          </div>
