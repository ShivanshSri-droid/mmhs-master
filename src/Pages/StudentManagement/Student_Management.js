...
const Student_Management = (data) => {
  return (
    <div className="student">
        <div className="student__top">
            <div className="student__top_button">
                <button type="button"  className="student__top_button_button">
                    <img className="student__top_button_img" src={upload} alt="upload" />   
                    Upload Master
                </button>
            </div>
            <div className="student__top_button">
                <button type="button"  className="student__top_button_button">
                    <img className="student__top_button_img" src={download} alt="upload" />   
                    Download Master
                </button>
            </div>
        </div>
        <div className="student__middle">
            <table >
                ...
                {tempData.map((data)=>{
                    return(
                        <tr className="student__middle_tr" >
                            <td className="student__middle_td">{data.gr_number}</td>
                            ...
                            <td className="student__middle_td">{data.mName}</td>
                            <td className="student__middle_td">{data.mEmail}</td>
                            <td className="student__middle_td">{data.mPhone}</td>
                            <td className="student__middle_td">{data.fName}</td>
                            <td className="student__middle_td">{data.fEmail}</td>
                            <td className="student__middle_td">{data.fPhone}</td>
                            <td className="student__middle_td"><a href="#"><img src={email} /></a></td>
                            <td className="student__middle_td"><div className="student__middle_td_activate"><a href="#">Activate</a></div></td>
                            <td className="student__middle_td"><div className="student__middle_td_generate_password"><a href="#">Generate Password</a></div></td>
                        </tr>
                    );
                })}
        ...
        <p>Showing 10 from 46 data</p>
              <div className="student__bottom_box">
                <button type="button" className="student__button_box_arrow"><img src={left_arrow} alt="left arrow"/></button>
                <button type="button" className="student__bottom_box_selected_num" >1</button>
                <button type="button" className="student__button_box_num" >2</button>
                <button type="button" className="student__button_box_num" >3</button>
                <button type="button" className="student__button_box_num" >4</button>
                <button type="button" className="student__button_box_arrow" ><img src={right_arrow} alt="left arrow"/></button>
              </div>
        </div>
    </div>
    );
